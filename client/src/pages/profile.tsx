import { Shield, LogOut, Wallet, Trash2, Edit2, Server, Sun, Moon, Eye, Plus, GripVertical, Download, Upload, FileArchive, QrCode, Camera, Cloud, AlertTriangle, Lock, Key, RefreshCw, Send } from 'lucide-react';
    ...
    <div className="px-4 py-6">
      ...
      <div className="bg-white dark:bg-card border border-border rounded-xl p-6 mb-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            DEXrp Tools is free and open source — unlimited wallets, no subscription required. All data is stored locally on your device.
          </p>
          <div className="p-4 bg-muted/30 rounded-lg border border-border">
            <p className="text-xs text-muted-foreground mb-3">
              If you find DEXrp Tools useful, consider supporting development with a donation.
            </p>
